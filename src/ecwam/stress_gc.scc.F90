...
!
MODULE STRESS_GC_SCC_MOD
  CONTAINS
  FUNCTION STRESS_GC_SCC (ANG_GC, USTAR, Z0, Z0MIN, HALP, RNFAC)
    ...
    USE YOWFRED, ONLY: NWAV_GC, OMEGA_GC, XK_GC, OMXKM3_GC, CM_GC, C2OSQRTVG_GC, XKMSQRTVGOC2_GC, OM3GMKM_GC, DELKCC_GC_NS,  &
    & DELKCC_OMXKM3_GC
...
!$acc routine seq
    ...
    END DO
    STRESS_GC_SCC = MAX(ZABHRC*TAUWCG, TAUWCG_MIN)
    
    
  END FUNCTION STRESS_GC_SCC
END MODULE STRESS_GC_SCC_MOD
