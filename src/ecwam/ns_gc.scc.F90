...
!
MODULE NS_GC_SCC_MOD
  CONTAINS
  FUNCTION NS_GC_SCC (USTAR)
...
!$acc routine seq
    ...
    NS_GC_SCC = MIN(INT(LOG(XKS*XKM_GC(1))*XLOGKRATIOM1_GC) + 1, NWAV_GC - 1)
    
    
  END FUNCTION NS_GC_SCC
END MODULE NS_GC_SCC_MOD
