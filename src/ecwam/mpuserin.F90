...
!        ---------------------
      ...
      WRITE(IU06,*) ' '
      WRITE(IU06,'(3A)') '  THE WAVE MODEL NAMELIST "',&
        & NAMELIST_FILENAME,'" IS BEING READ'
      IU05 =  IWAM_GET_UNIT (IU06, NAMELIST_FILENAME, &
        &'s', 'f', 0, 'READ')
      ...
      ELSE
        ...
        WRITE(IU06,*)'+                                          +'
        WRITE(IU06,*)'++++++++++++++++++++++++++++++++++++++++++++'
     CALL WAM_ABORT("Could not read namelist '"//NAMELIST_FILENAME//"'",&
