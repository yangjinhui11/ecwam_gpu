...
! ----------------------------------------------------------------------
      ...
      IF (.NOT. LLEXIST) THEN
        ...
        WRITE (IU06,*) 'Set the output FIELD to zero Yangjinhui*'
        WRITE (IU06,*) '*************************************'
        RFIELD = 0._JWRB  ! Yangjinhui
          RFIELD(IJINF:IJSUP,6) = 0.00001_JWRB! Yangjinhui
          RFIELD(IJINF:IJSUP,8) = 0.018_JWRB  ! Yangjinhui
          RFIELD(IJINF:IJSUP,9) = 1.225_JWRB ! Yangjinhui
        CDTPRO = '00000000000000'
        CDATEWO ='00000000000000'
        CDAWIFL= '00000000000000'
        CDATEFL= '00000000000000'
        ...
        !CALL ABORT1
      ENDIF
      IUNIT=IWAM_GET_UNIT(IU06, FILENAME(1:LFILE) , &
        &'r', 'u', 0, 'READWRITE')
