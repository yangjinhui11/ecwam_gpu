...
! ----------------------------------------------------------------------
!$acc declare create(KLAT,KLON,WLAT,KCOR,WCOR,WLATN)
!$acc declare create(LLWLATN,SUMWN,WLONN,LLWLONN)
!$acc declare create(WCORN,LLWCORN,WKPMN,LLWKPMN)
!$acc declare create(WMPMN,LLWMPMN)
!$acc declare create(JXO,JYO,KCR,KPM,MPM)
!$acc declare create(OBSLAT,OBSLON,OBSCOR)
!$acc declare create(WRLAT,WRLON,KRLAT,KRLON,OBSRLON,OBSRLAT)
      END MODULE YOWUBUF
