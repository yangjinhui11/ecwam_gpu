...
END INTERFACE
INTERFACE MPL_WAITS
  MODULE PROCEDURE MPL_WAITS_FIAT,MPL_WAIT1_FIAT ! Yangjinhui from fiat
ENDINTERFACE
PUBLIC MPL_WAIT, MPL_WAITS
...
SUBROUTINE MPL_WAITS_FIAT(KREQUEST,KOUNT,KBYTES,KERROR,CDSTRING)
...
RETURN
END SUBROUTINE MPL_WAITS_FIAT

SUBROUTINE MPL_WAIT1_FIAT(KREQUEST,KOUNT,KBYTES,KERROR,CDSTRING)
